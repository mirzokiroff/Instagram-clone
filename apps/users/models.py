...
class UserProfile(AbstractUser):
    ...
    image = FileField(upload_to='profile/', validators=[FileExtensionValidator(['jpg', 'png'])], blank=True, null=True)
    followers = ManyToManyField(to='self', related_name='my_followers', symmetrical=False, blank=True)
    following = ManyToManyField(to='self', related_name='my_following', symmetrical=False, blank=True)
    likes = ManyToManyField(to='self', related_name='my_likes', symmetrical=False, blank=True)
    is_public = BooleanField(default=True)
    user_posts = ManyToManyField('content.Post', related_name='users_posts', blank=True)
    user_reels = ManyToManyField('content.Reels', related_name='users_reels', blank=True)
    user_stories = ManyToManyField('content.Story', related_name='users_stories', blank=True)
    user_highlights = ManyToManyField('content.Highlight', related_name='users_highlights', blank=True)
